...
public class AkkaDeadletter  {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ActorRef existingActor = actorSystem.actorOf(Props.create(MyActor.class, countDownLatch),"ExistingActor");
        ActorRef DLH = actorSystem.actorOf(Props.create(DeadLettersHandler.class, countDownLatch), "DeadLetterHandler");
